# Что делать если я только знаю слова докер и кубер, но понятия не имею, что они значат?
## Курсы с практикой
- [курс по докеру и базовому кубу, первые 2 темы ,можно ещё экз пройти, дальше особо не нужно, только  если есть много времени и желания. ]( https://stepik.org/course/99188/) // Скорее всего это(то что после двух тем) спросят на 1 собесе из 100 и скорее всего к этому не пустят разрабов в нормальном проекте
- [Гайды с оффициального сайта докера](https://www.docker.com/play-with-docker/)
- [Курс по докеру](https://karpov.courses/docker)
- [Не уверен, что он все ещё бесплатен, но объясняют нормально](https://kodekloud.com/courses/docker-for-the-absolute-beginner/)
## Теория
