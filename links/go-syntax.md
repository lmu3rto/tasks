# Что делать если я не знаю синтаксис и мне сложно писать код на го?
- [Курс от яндекса #1, просто узнать, что вообще в этом языке делают](https://practicum.yandex.ru/go-developer-basic)
- [Курс от хекслета, тоже просто разобраться что вообще тут происходит](https://ru.hexlet.io/programs/go-basics)
- [Курс на степике, не прям уж свежий, но базово хорошо рассказывают и много практических задач](https://stepik.org/course/54403)
- [Курс от яндекса #2, более сложные темы затрагиваются, я бы проходил его после самых основ](https://start.practicum.yandex/go-basics)
- [Не курс, а скорее то , как правильно делать и писать, когда начинал изучать язык и работать, отсюда первое время брал что-то отсюда](https://gobyexample.com/)
...
- [курс по го с большим количеством практики](https://stepik.org/course/220674)
...
# Конкурентность и gmp модель 
- [Возможно сложно для первого раза, в целом хорошее видео](https://www.youtube.com/watch?v=mvUiw9ilqn8) 
...
# Интерфейсы 
- [Видео на английском про интерфейсы ](https://www.youtube.com/watch?v=SX1gT5A9H-U)  
- [Про место определения интерфейсов, Николай Тузов](https://www.youtube.com/watch?v=eYHCCht8eX4)
- [в целом про смысл интерфейсов в языке](https://www.youtube.com/watch?v=7Cmp8ySxauc)
- [Cтатья от вк на хабре](https://habr.com/ru/companies/vk/articles/463063/) 
